...
num = 0
for image_path in glob.glob('../../workspace/detection_training/test/images_to_test/*.jpg'):
  ...
  plt.savefig(F"../../workspace/detection_training/test/images_tested/image{num}.png")
  plt.show()
  num += 1